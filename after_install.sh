...
yay -S swaynagmode vlc puddletag-git qt5-styleplugins gtk-theme-numix-solarized numix-icon-theme-git kotatogram-desktop-bin virtualbox-ext-oracle mimeo perl-file-mimeinfo libtorrent-rasterbar-1_2-git qbittorrent-enhanced-git pipewire libpipewire02 xdg-desktop-portal xdg-desktop-portal-wlr fedora-firefox-wayland-bin chromium wofi-hg ytop-bin nerd-fonts-dejavu-complete i3ipc-python-git clipman tor-browser deadbeef-git deadbeef-mpris2-plugin translate-shell obs-studio-wayland wlrobs zoom jmtpfs swaylock-effects-git yandex-disk adbfs-rootless-git scrcpy nm-connection-editor networkmanager-openvpn hunspell hunspell-en_US hunspell-ru-aot-ieyo hyphen hyphen-en hyphen-ru --noconfirm --sudoloop
